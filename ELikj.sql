...
CREATE TABLE `ELi_features` (
  ...
  KEY `type` (`type`),
  KEY `type_2` (`type`,`off`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='插件列表';

-- ----------------------------
-- Records of ELi_features
-- ----------------------------
BEGIN;
INSERT INTO `ELi_features` VALUES (1, 'admin', '', 'layui-icon-console', '管理后台', '基础管理后台', 'U', 'https://www.elikj.com/', '1', 1, '', 1585446010, '', '', '{\"verifyip\":[\"\\u5173\\u95ed\",\"\\u5f00\\u542f\"],\"off\":[\"\\u5173\\u95ed\",\"\\u5f00\\u542f\"],\"off2\":[\"\\u5173\\u95ed\",\"\\u5f00\\u542f\"],\"adminlogtype\":[\"\\u767b\\u9646\",\"\\u9000\\u51fa\",\"\\u6324\\u6389\",\"\\u4fee\\u6539\",\"\\u63d2\\u5165\",\"\\u5220\\u9664\"],\"userlogtype\":[\"\\u767b\\u9646\",\"\\u9000\\u51fa\",\"\\u6324\\u6389\",\"\\u4fee\\u6539\",\"\\u63d2\\u5165\",\"\\u5220\\u9664\"],\"currencylog\":[\"\\u6d4b\\u8bd51\",\"\\u5531\\u7684his2\"]}', 0, '', '{\"admin\":{\"name\":\"管理里员\",\"typeico\":\"layui-icon-friends\",\"link\":\"\"},\"admingroup\":{\"name\":\"权限管理\",\"typeico\":\"layui-icon-group\",\"link\":\"\"},\"adminlog\":{\"name\":\"管理日志\",\"typeico\":\"layui-icon-table\",\"link\":\"\"},\"features\":{\"name\":\"插件管理\",\"typeico\":\"layui-icon-engine\",\"link\":\"\"},\"config\":{\"name\":\"通用配置\",\"typeico\":\"layui-icon-set\",\"link\":\"\"},\"currencylog\":{\"name\":\"货币日志\",\"typeico\":\"layui-icon-dollar\",\"link\":\"\"},\"integrallog\":{\"name\":\"积分日志\",\"typeico\":\"layui-icon-diamond\",\"link\":\"\"},\"moneylog\":{\"name\":\"金额日志\",\"typeico\":\"layui-icon-rmb\",\"link\":\"\"},\"user\":{\"name\":\"用户管理\",\"typeico\":\"layui-icon-user\",\"link\":\"\"},\"userlog\":{\"name\":\"用户日志\",\"typeico\":\"layui-icon-list\",\"link\":\"\"},\"memcached\":{\"name\":\"数据库KV\",\"typeico\":\"layui-icon-find-fill\",\"link\":\"\"}}', 0);
COMMIT;
